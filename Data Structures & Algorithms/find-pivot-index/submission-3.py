...
# Apprach 2# why keep an entire prefix sum array, 
# instead if we have the total_sum of the array and running_sum until that index
# left = running_sum
# right = total - left - current_number

        # total_sum = sum(nums)
        # left = 0  # This takes the place of our prefix_sum array
        
        # for i, num in enumerate(nums):
        #     # Calculate the sum of everything strictly to the right
        ...
        #     # Update the left running sum for the next index
        #     left += num
