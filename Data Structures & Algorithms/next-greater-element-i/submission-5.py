    ...
    #    # Space Complexity: O(len(nums1))
       ...
       # Idea 2:
        ...
        for num in nums2:
            ...
            stack.append(num)
        # decreasing order from bottom to top. When a new element is larger than the stack top,
        # we pop elements and record the current element as their next greater. We only push elements that are in nums1 since those are the only ones we need answers for.
        while stack:
            leftover = stack.pop()
